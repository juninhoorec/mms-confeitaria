(async () => {
  ...
  const initReadyCarousel = grid => {
    ...
    const play = () => { clearInterval(timer); timer = setInterval(() => goTo(index + 1), 3000); };
