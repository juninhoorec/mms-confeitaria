...
const PRODUCTS = {
    ...
    'chantininho-pink': {
        ...
        customization: {
            pricePerKg: 80,
            masses: { baunilha: 'Baunilha', chocolate: 'Chocolate' },
            fillings: {
                'coco-cremoso': 'Coco cremoso',
                'chocolate-50': 'Chocolate 50%',
                ninho: 'Ninho',
    ...
    'cenoura-trufada': {
        name: 'Bolo de Cenoura Trufada',
        price: 28,
        category: 'highlights',
        defaultFinish: 'cobertura',
        leadTimeHours: 20,
        image: 'assets/cenoura trufada bolo.png',
        description: 'Massa macia de cenoura com cobertura trufada de chocolate e finalização generosa de granulado.',
        ingredients: ['Cenoura', 'Chocolate', 'Leite condensado', 'Granulado'],
        pricing: { pequeno: { cobertura: 28 }, medio: { cobertura: 40 }, grande: { cobertura: 55 } },
    },
    'ninho-de-uva': {
        name: 'Bolo Ninho de Uva',
        price: 28,
        category: 'highlights',
        defaultFinish: 'cobertura',
        leadTimeHours: 20,
        image: 'assets/ninho de uva bolo.png',
        description: 'Bolo macio coberto com creme de Ninho e finalizado com uvas verdes frescas.',
        ingredients: ['Massa branca', 'Leite Ninho', 'Leite condensado', 'Uvas verdes'],
        pricing: { pequeno: { cobertura: 28 }, medio: { cobertura: 40 }, grande: { cobertura: 55 } },
    },
    'caseiro-meio-a-meio': {
        name: 'Bolo Caseiro Meio a Meio',
        price: 28,
        category: 'highlights',
        defaultFinish: 'cobertura',
        leadTimeHours: 20,
        image: 'assets/caseiro meio a meio bolo.png',
        description: 'Duas combinações de sabor em um só bolo caseiro, com cobertura cremosa e acabamento artesanal.',
        ingredients: ['Massa artesanal', 'Chocolate', 'Creme de Ninho', 'Leite condensado'],
        pricing: { pequeno: { cobertura: 28 }, medio: { cobertura: 40 }, grande: { cobertura: 55 } },
    },
    ...
    'mini-caseirinho-massa-vermelha': {
        name: 'Mini Caseirinho Massa Vermelha', price: 12, category: 'house', subgroup: 'mini',
        image: 'assets/mini caseirinho massa vermelha.png',
        description: 'Mini bolo de massa vermelha aveludada com cobertura branca cremosa e farelos de red velvet.',
        ingredients: ['Massa vermelha', 'Creme branco', 'Leite condensado', 'Baunilha'],
    },
    'mini-caseirinho-oreo': {
        name: 'Mini Caseirinho Oreo', price: 12, category: 'house', subgroup: 'mini',
        image: 'assets/mini caseirinho oreo 2.png',
        description: 'Mini bolo caseiro com cobertura cremosa e pedaços crocantes de biscoito Oreo.',
        ingredients: ['Massa artesanal', 'Creme branco', 'Biscoito Oreo', 'Leite condensado'],
    },
    'mini-caseirinho-formigueiro': {
        name: 'Mini Caseirinho Formigueiro', price: 12, category: 'house', subgroup: 'mini',
        image: 'assets/mini caseirinho formigueiro.png',
        description: 'Mini bolo formigueiro macio, assado artesanalmente para acompanhar o café ou presentear.',
        ingredients: ['Farinha de trigo', 'Ovos', 'Leite', 'Granulado de chocolate'],
    },
    'mini-caseirinho-chocolate': {
        name: 'Mini Caseirinho de Chocolate', price: 12, category: 'house', subgroup: 'mini',
        image: 'assets/mini caseirinho chocolate.png',
        description: 'Mini bolo de chocolate com cobertura cremosa, granulado e morangos frescos.',
        ingredients: ['Massa de chocolate', 'Chocolate', 'Granulado', 'Morangos'],
    },
    'mini-caseirinho-prestigio': {
        name: 'Mini Caseirinho Prestígio', price: 12, category: 'house', subgroup: 'mini',
        image: 'assets/mini caseirinho prestigio.png',
        description: 'Mini bolo caseiro com cobertura cremosa de coco e finalização de coco ralado.',
        ingredients: ['Massa artesanal', 'Coco', 'Leite condensado', 'Creme de leite'],
    },
    'pote-chocolate': {
    ...
    'pote-ninhoella': {
        name: 'Bolo de Pote Ninhoella', price: 10, category: 'sweets',
        image: 'assets/ninhoella bolo de pote.png',
        description: 'Camadas de massa macia, creme de Ninho e chocolate cremoso em uma combinação irresistível.',
        ingredients: ['Massa de bolo', 'Leite Ninho', 'Chocolate', 'Leite condensado'],
    },
    'pote-nuvem-de-limao': {
        name: 'Bolo de Pote Nuvem de Limão', price: 10, category: 'sweets',
        image: 'assets/nuvem de limao bolo de pote.png',
        description: 'Camadas delicadas de bolo e creme de limão, com sabor fresco e textura leve.',
        ingredients: ['Massa de bolo', 'Limão', 'Leite condensado', 'Creme de leite'],
    },
    'pote-ninho-tropical': {
        name: 'Bolo de Pote Ninho Tropical', price: 10, category: 'sweets',
        image: 'assets/ninho tropical bolo de pote.png',
        description: 'Bolo de chocolate em camadas com creme de Ninho e cobertura tropical de maracujá.',
        ingredients: ['Massa de chocolate', 'Leite Ninho', 'Maracujá', 'Leite condensado'],
    },
    'pote-brigadeiro-supremo': {
        name: 'Bolo de Pote Brigadeiro Supremo', price: 10, category: 'sweets',
        image: 'assets/brigadeiro supremo bolo de pote.png',
        description: 'Camadas de massa clara e brigadeiro cremoso, finalizadas com granulado de chocolate.',
        ingredients: ['Massa de bolo', 'Chocolate', 'Leite condensado', 'Granulado'],
    },
    'pote-baunilha-chocolate': {
        name: 'Bolo de Pote Baunilha com Chocolate', price: 10, category: 'sweets',
        image: 'assets/bolo de pote baunilha com chocolate.png',
        description: 'Massa de baunilha com creme suave e cobertura de chocolate em camadas equilibradas.',
        ingredients: ['Massa de baunilha', 'Chocolate', 'Leite condensado', 'Creme de leite'],
    },
    'pote-baunilha-banana': {
        name: 'Bolo de Pote Baunilha com Banana', price: 10, category: 'sweets',
        image: 'assets/bolo te pote baunilha com banana.png',
        description: 'Massa de baunilha, creme delicado e banana com toque caramelizado.',
        ingredients: ['Massa de baunilha', 'Banana', 'Leite condensado', 'Caramelo'],
    },
    'trio-bolos-de-pote': {
        name: 'Trio de Bolos de Pote', price: 30, category: 'sweets',
        image: 'assets/bolos de pote 3.png',
        description: 'Seleção com três bolos de pote para compartilhar ou experimentar sabores diferentes.',
        ingredients: ['Massas artesanais', 'Cremes variados', 'Chocolate', 'Leite condensado'],
    },
};
...
const CATALOG_PRESENTATION = {
    ...
    house: {
        ...
        title: 'Bolos caseiros & minis caseirinhos',
    },
    sweets: {
